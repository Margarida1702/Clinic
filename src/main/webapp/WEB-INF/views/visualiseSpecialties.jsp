        ...
        <div class="cust-mainContContainer h-100 col-md d-flex flex-column overflow-auto justify-content-between">
            ...
            <div class="d-flex flex-column h-100 cust-order-board align-items-center">
                ...
                <div class="db-row-ctn-center w-100">
                    <div class="db-opt-title mt-5">Especialidades</div>
                        ...
                        <div data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="50">
                            ...
                            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                                <div class="container-fluid">
                                    <ul class="navbar-nav">
                                        <c:forEach var="number" begin="1" end="${specialtyList.size()}">

                                            <li class="nav-item">
                                                <a class="nav-link" href="#section${number}">${specialtyList.get(number-1).getName()}</a>
                                            </li>
                                ...
                                <c:forEach var="number" begin="1" end="${specialtyList.size()}">
                                    ...
                                    <div id="section${number}" class="container-fluid bg-transparent" style="padding:100px 20px;">
                                        <h1 class="cust-color-gre-Up">${specialtyList.get(number-1).getName()}</h1>
                                        <p>${specialtyList.get(number-1).getDescription()}</p>
                                        <form method="get">
                                            <input value="${specialtyList.get(number-1).getId()}" name="specialty" type="hidden">
                                            <button formaction="appointment_slots" class="btn btn-primary cust-btn-blu-Up" type="submit">Marcar Consulta</button>
                                        </form>
                                    </div>
