...
<head>
    ...
    <title>Centro Hospitalar Upskill :: Registar Administrador</title>
    ...
    <div class="row h-100 cust-row-sb-and-maincont-ctn">
        ...
        <div class="cust-mainContContainer h-100 col-md d-flex flex-column overflow-auto">
            ...
            <div class="cust-title1-ctn">
                <div class="cust-title1-txt col-md px-3">Registar Administrador</div>
            </div>
            <!-- cust-title1-ctn End-->

            <!-- cust-registerAdmin-content -->
            <div class="cust-registerAdmin-content px-5 pt-5">
                ...
                <!-- cust-cust-admin-form-content -->
                <form method="post" id="admin-form" class="cust-admin-form" action="registerAdminProcess">
                ...
                </form> <!-- cust-cust-admin-form-content End -->
            </div> <!-- cust-registerAdmin-content End-->
